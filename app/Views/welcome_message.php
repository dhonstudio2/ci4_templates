...
<head>
    ...
    <title>Dhon Studio Projects</title>
    <!-- 
...
-->
    ...
    <link rel="stylesheet" href="<?= $assets ?>vendor/templatemo_520_highway/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= $assets ?>vendor/templatemo_520_highway/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="<?= $assets ?>vendor/templatemo_520_highway/css/fontAwesome.css">
    <link rel="stylesheet" href="<?= $assets ?>vendor/templatemo_520_highway/css/light-box.css">
    <link rel="stylesheet" href="<?= $assets ?>vendor/templatemo_520_highway/css/templatemo-style.css">

    <link href="https://fonts.googleapis.com/css?family=Kanit:100,200,300,400,500,600,700,800,900" rel="stylesheet">

    <script src="<?= $assets ?>vendor/templatemo_520_highway/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
</head>
...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="index.html">
                <!-- High<em>way</em> -->
                <img src="<?= $assets ?>img/logo_white.png" alt="Dhon Studio Logo" width="82">
            </a>
        </div>
        <div class="menu-icon">
            <span></span>
    ...
    <div id="video-container">
        ...
        <div class="video-content">
            <div class="inner">
                <h1>Welcome to <em>Our Projects</em></h1>
        ...
        <div class="container-fluid">
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="<?= base_url('templatemo/digitaltrend') ?>" target="_blank">
                        <div class="thumb">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <h1 style="color: black;">Digital <em>Trend</em></h1>
                                    <p style="color: black;">Digital Marketing Landing Page</p>
                                </div>
                            </div>
                            <div class="image">
                                <img src="<?= $assets ?>vendor/templatemo_520_highway/img/chrome_Vqc262w9AS.png">
                            </div>
                        </div>
                    </a>
                </div>
